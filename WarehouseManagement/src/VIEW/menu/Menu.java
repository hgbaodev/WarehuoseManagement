...
public class Menu extends javax.swing.JPanel {
    ...
    private void addMenu(String menuName, String icon, int index) {
        ...
        m.setIcoName(icon);
        m.setIcon(new ImageIcon(getClass().getResource("/VIEW/icon/" + icon + ".png")));
        ...
        for (Component com : menu.getComponents()) {
            if (com instanceof MenuButton) {
                ...
                if (!c.getIcoName().contains("_s")) {
                    c.setIcon(new ImageIcon(getClass().getResource("/VIEW/icon/" + c.getIcoName() + ".png")));
                }
            }
        }
    }
    ...
    public void setSelectedMenu(int index) {
        ...
        cmd.setIcon(new ImageIcon(getClass().getResource("/VIEW/icon/" + cmd.getIcoName() + "_s.png")));
    }
    ...
    private void initComponents() {
        ...
        imageAvatar1 = new theme.ImageAvatar();
        ...
        imageAvatar1.setImage(new javax.swing.ImageIcon(getClass().getResource("/VIEW/icon/kali.png"))); // NOI18N
    ...
    private theme.ImageAvatar imageAvatar1;
