...
public class Menu extends JPanel{
    ...
    public void init(){
        ...
        imageAvatar.setGradientColor1(new java.awt.Color(18, 130, 227));
        imageAvatar.setGradientColor2(new java.awt.Color(226, 45, 60));
        imageAvatar.setImage(new javax.swing.ImageIcon(getClass().getResource("/icon/6600106.png"))); // NOI18N
    ...
    private void addMenu(String menuName, String icon, int index) {
        ...
        m.setIcoName(icon);
        m.setIcon(new ImageIcon(getClass().getResource("/icon/" + icon + ".png")));
        ...
        for (Component com : menu.getComponents()) {
            if (com instanceof MenuButton) {
                ...
                if (!c.getIcoName().contains("_s")) {
                    c.setIcon(new ImageIcon(getClass().getResource("/icon/" + c.getIcoName() + ".png")));
                }
            }
        }
    }
    ...
    public void setSelectedMenu(int index) {
        ...
        cmd.setIcon(new ImageIcon(getClass().getResource("/icon/" + cmd.getIcoName() + "_s.png")));
    }
