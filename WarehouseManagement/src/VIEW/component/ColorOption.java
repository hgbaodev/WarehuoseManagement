...
public class ColorOption extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        button1 = new sswing.Button();
        button2 = new sswing.Button();
        button3 = new sswing.Button();
        button4 = new sswing.Button();
        button5 = new sswing.Button();
        ...
        button5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/VIEW/icon/color_check.png"))); // NOI18N
    ...
    private void setSelected(JButton cmd) {
        ...
        cmd.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/color_check.png")));
    ...
    private sswing.Button button1;
    private sswing.Button button2;
    private sswing.Button button3;
    private sswing.Button button4;
    private sswing.Button button5;
